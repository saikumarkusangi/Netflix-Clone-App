...
class Only_on_Netflix extends StatelessWidget {
          ...
          Container(
            ...
            child: StreamBuilder<QuerySnapshot>(
                 stream: FirebaseFirestore.instance
                      .collection('Only on Netflix').orderBy('name',descending: true)
                      .snapshots(),
                  ...
                  //Trending 
                      child: Padding(
                        ...
                        child: Container(
                                  height: 250,
                                  width: 170,
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), image: DecorationImage(image: NetworkImage('${docs[i]['poster']}'),fit: BoxFit.cover)),
                                ),
                      ),
                            ),
                            Flexible(
